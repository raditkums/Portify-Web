function back() {
        ...
        const profiles = {
            joanne: {
                ...
                desc2: 'Berkolaborasi dengan tim untuk mengembangkan dan memamerkan produk bernama LensGO, aplikasi terkait kacamata, sebagai bagian dari proyek kewirausahaan universitas. Terlibat dalam perencanaan, pembuatan, dan penyajian konsep selama festival.',
                ...
                socialMedia: { // Standardized social media object
            ...
            ingrid: {
                ...
                socialMedia: { // Added social media for Ingrid (example, fill with real links)
            ...
            vannesia: {
                ...
                socialMedia: { // Added social media for Vannesia (example, fill with real links)
            ...
            raditya: {
                ...
                education: 'Bina Nusantara University Accounting and Information Systems',
                achievements: [
                    'Aktif di BinusTV, mengelola program media kampus'
                ],
                ...
                socialMedia: { // Standardized this to use a socialMedia object
        ...
        // Fungsi untuk menampilkan detail profil individu saat diklik
        function showProfile(member) {
            ...
            if (!profile) {
                document.getElementById('profileDetails').innerHTML = '<p style="color: white; text-align: center; padding: 50px;">Profil tidak ditemukan.</p>';
                return;
            }
            ...
            const html = `
                <header>
                    <div class="navbar">
                        ...
                        <nav>
                            <ul>
                                <li><a href="#" data-target="profile-main-info-card">Tentang Saya</a></li>
                                <li><a href="#" data-target="experience-section">Pengalaman Organisasi</a></li>
                                <li><a href="#" data-target="skills-section">Skills</a></li>
                                <li><a href="#" data-target="contact-card">Hubungi Saya</a></li>
                            </ul>
                        </nav>
                    </div>
                </header>
                ...
                <div class="main-content-wrapper">
                    <div class="profile-main-info-card">
                        ...
                        <h1>${profile.name}</h1>
                        <h3>${profile.title || 'Accounting & Information Systems'}</h3> <!-- Use profile.title or default -->
                    <section class="professional-profile-summary">
                        <h2>Tentang Saya</h2>
    ...
    // Menampilkan konten
    document.getElementById('profileDetails').innerHTML = profileContent;
    document.getElementById('profileDetails').classList.remove('hidden');
